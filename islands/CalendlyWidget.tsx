			...
			{isExpanded
				? (
					<>
						...
						<button
							className='fixed bottom-0 left-0 mb-10 ml-10 flex items-center justify-center p-2.5 text-white bg-blue-600 rounded-lg shadow-lg outline-none border-none hover:text-gray-300'
