pub mod hex {
	...
	/// ## Example:
	/// ```
	/// let difference = hex_difference("#ffffff", "#0000000");
	/// ```
	/// output: `255`
	fn compare_hex_rgb(hex1: &str, hex2: &str) -> f64 {
		...
		let r = (r1 as f64 - r2 as f64).abs();
		let g = (g1 as f64 - g2 as f64).abs();
		let b = (b1 as f64 - b2 as f64).abs();
	...
	/// ## Example:
	/// ```
	/// let difference = hex_difference("#ffffff", "#0000000", 255);
	/// ```
	/// output: `true`
	/// ```
	/// let difference = hex_difference("#ffffff", "#0000000", 254);
	/// ```
	/// output: `false`
