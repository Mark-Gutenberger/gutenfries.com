	...
	if (hide) {
		return (
			<div className='fixed bottom-0 right-[5%] z-50'>
				<div className='text-lg w-24 h-6 hover:w-auto hover:h-auto bg-blue-500 rounded-t-lg'>
					<Icons.ChevronUp className='w-6 h-6 text-gray-900' />
					<h3 className='my-2 text-xl mx-4 text-gray-900 text-center'>
						Display different content
					</h3>
					<div className='pb-2 flex justify-center'>
						<a
							className='text-gray-800 hover:text-gray-700 active:text-gray-600 underline px-4'
							href='/?content=tech'
						>
							Tech
						</a>
