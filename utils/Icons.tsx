...
class Icons {
	public static DesktopComputer = (_?: IconProps) => (
		<svg
	...
	public static Sun = (_?: IconProps): JSX.Element => (
		<svg
			className={_?.className ?? undefined}
			stroke={_?.stroke ?? 'currentColor'}
			fill={_?.fill ?? 'none'}
	...
	public static Moon = (_?: IconProps): JSX.Element => (
		<svg
			className={_?.className ?? undefined}
			stroke={_?.stroke ?? 'currentColor'}
			fill={_?.fill ?? 'none'}
	...
	public static Discord = (_?: IconProps): JSX.Element => (
		<svg
			className={_?.className ?? undefined}
			stroke={_?.stroke ?? 'currentColor'}
			fill={_?.fill ?? 'none'}
