					...
					<div className='flex flex-wrap dark:border-gray-300 -m-4 text-gray-100'>
						<div className='p-4 md:w-1/3'>
							...
							>
								...
								to reach youth through the music of different cultures and time
								periods. Our goal is to create a sense of cultural unity through the
								music from each of our parts of the world.
							</RecentActivityCard>
						</div>
						<div className='p-4 md:w-1/3'>
							<RecentActivityCard
							...
							>
								...
								Drum & Bugle Corps for the 2023 DCI Season. I also received a
								contract to march Legends PAA for the 2022 DCI season.
							</RecentActivityCard>
						</div>
						<div className='p-4 md:w-1/3'>
							<RecentActivityCard
							...
							>
								...
								state Computer Programming award for best performance across a
								written test, 3 written programs, and a technical interview. The
								competition attendance was 150+ high school and college students.
							</RecentActivityCard>
						</div>
					</div>
				</section>
				<section className='mx-auto px-5 py-40 container'>
					...
					<div className='flex flex-wrap -m-4'>
						<TechCard
							...
							icon={<IconSettings />}
						>
							I've been writing Rust code for several years, and I am very familiar
							with with the <Link href='https://crates.io'>ecosystem</Link>,{' '}
							and advanced language features. I have written numerous applications in
							the Rust language from the ground up, and others upon existing
							codebases.
						</TechCard>
						...
						>
							I am very familiar with Docker and have used it alongside almost all
							code I write, including{' '}
							<Link href='https://github.com/gutenfries/gutenfries.deno.dev'>
								this website
