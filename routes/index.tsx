							...
							<div className='flex flex-wrap -m-4 text-gray-100 dark:border-gray-300'>
								...
								<div className='p-4 md:w-1/3'>
									<div className='flex rounded-lg h-full bg-gray-800 p-8 flex-col'>
										...
										<div className='flex-grow'>
											<p className='text-lg text-base'>
												I created Tetris in C++ using std and ncurses,
												utilizing the Object-Oriented language features.
											</p>
							...
							<div className='flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center'>
								...
								<div className='flex flex-col mb-10 lg:items-start items-center'>
									<div className='flex-grow'>
										...
										<p className='text-lg text-base'>
											...
											technologies, as well as systems langauges, C/C++ and
											Rust.
										</p>
										{
								...
								<div className='flex flex-col mb-10 lg:items-start items-center'>
									<div className='flex-grow'>
										...
										<p className='text-lg text-base'>
											I am a musician, namely a drummer. I have been playing
											for several years and am passionate about jazz and
											corps-style rudimental drumming. I also play guitar,
								...
								<div className='flex flex-col mb-10 lg:items-start items-center'>
									<div className='flex-grow'>
										...
										<p className='text-lg text-base'>
											Aside from programming and music, I enjoy mountain
											biking, skiing, and learning new things. I really enjoy
											good coffee and spending time with friends.
										</p>
										{
											/* <a className='mt-3 text-blue-500 inline-flex items-center hover:text-blue-600 active:text-gray-700'>
									Learn More
						...
						<div className='container px-5 py-32 mx-auto'>
							<div className='xl:w-1/2 lg:w-3/4 w-full mx-auto text-center'>
								...
								<p className='text-lg text-lg'>
									...
									master cleanse direct trade blue juice before they sold out
									gentrify plaid gastropub normcore XOXO 90's pickled cblue jean
									shorts. Slow-carb next level shoblueitch ethical authentic, yr
